                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="requestTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="diajukan-tab" data-bs-toggle="tab" data-bs-target="#diajukan"
                                    type="button" role="tab" aria-controls="diajukan" aria-selected="false">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="diproses-tab" data-bs-toggle="tab" data-bs-target="#diproses"
                                    type="button" role="tab" aria-controls="diproses" aria-selected="false">
                        ...
                        <div class="tab-content mt-3" id="requestTabsContent">
                            ...
                            @foreach (['semua', 'diajukan', 'diproses', 'selesai', 'ditolak'] as $tabStatus)
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                    id="{{ $tabStatus }}" role="tabpanel" aria-labelledby="{{ $tabStatus }}-tab">
