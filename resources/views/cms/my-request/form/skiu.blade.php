<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('business_name') is-invalid @enderror"
                        ...
                        value="{{ old('business_name', isset($requestLetter) ? $requestLetter->business_name : '') }}"
                        required>
                    @error('business_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3">
                    <label for="business_start_date" class="form-label">Mulai Usaha Sejak <span
                            class="text-danger">*</span></label>
                    <input type="date" class="form-control @error('business_start_date') is-invalid @enderror"
                        id="business_start_date" name="business_start_date"
                        value="{{ old('business_start_date', isset($requestLetter) ? $requestLetter->business_start_date : '') }}"
                        required>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <label for="business_address" class="form-label">Alamat Usaha <span
                            class="text-danger">*</span></label>
                    <textarea class="form-control @error('business_address') is-invalid @enderror" id="business_address"
                        name="business_address" rows="3" required>{{ old('business_address', isset($requestLetter) ? $requestLetter->business_address : '') }}</textarea>
