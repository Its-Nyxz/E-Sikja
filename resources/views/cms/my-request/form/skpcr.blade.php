<div class="container">
    <div class="row justify-content-center">
        <div class="mb-4">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <label for="divorce_year" class="form-label">Tahun Perceraian <span class="text-danger">*</span></label>
                    <input type="number" class="form-control @error('divorce_year') is-invalid @enderror" 
                        id="divorce_year" name="divorce_year" value="{{ old('divorce_year', isset($requestLetter) ? $requestLetter->divorce_year : '') }}" required>
                    @error('divorce_year')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
