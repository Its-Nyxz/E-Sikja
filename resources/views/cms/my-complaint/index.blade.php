        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="complaint-form" action="{{ route('pengaduan-saya.store') }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="current-image" class="mt-2" style="display: none;">
                                    <img src="" alt="Current Image" class="img-thumbnail"
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-warning', function(e) {
                ...
                $.get(href, function(data) {
                    ...
                    $('#complaint-form').attr('action', "{{ url('pengaduan-saya') }}/update/" +
                        data.id);
                    ...
                    if (data.image_url) {
                        ...
                        $('#current-image img')
                            .attr('src', data.image_url + '?t=' + new Date().getTime())
                            .css({
                                'user-select': 'none',
                ...
                $.get("{{ url('pengaduan-saya') }}/show/" + id, function(data) {
                    ...
                    if (data.image) {
                        $('#modal-image').html(
                            ...
                            '<img src="' + data.image +
                            '" class="img-fluid rounded" style="max-height: 300px; user-select:none; -webkit-user-drag:none; pointer-events:none;">' +
